TRUNCATE project, employee, department, employee_project RESTART IDENTITY CASCADE;
...
INSERT INTO employee
  (employee_name, phone, title, salary, department_id)
  VALUES
...
UPDATE department SET manager_id = 7 WHERE id = 1;
UPDATE department SET manager_id = 3 WHERE id = 2;
UPDATE department SET manager_id = 6 WHERE id = 3;
